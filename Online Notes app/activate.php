		...
		<div class="row">
			<div class="offset-sm-1 col-sm-10 offset-md-0 col-md-12 message">
				...
				<?php
					...
					$result = mysqli_query($conn, "UPDATE `users` SET `activation`='activated' WHERE `email` = '$email' AND `activation` = '$key' ") or die(mysqli_error());
					
					if(mysqli_affected_rows($conn) == '1'){
						echo "<div class='col-8 alert alert-success'>Your account has been activated.</div>";
						echo "<a href='http://localhost/Online%20Notes%20app/index.php' class='btn btn-success btn-lg m-3'>Login In</a>";
					}else{
